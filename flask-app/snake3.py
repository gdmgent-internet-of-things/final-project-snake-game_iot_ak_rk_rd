...
class SNAKE2:
    def __init__(self, start_pos):
        ...
        self.head = pygame.image.load('Snakes/snake_hooft_groen.png').convert_alpha()
        self.head_rotation = 0

        self.tail = pygame.image.load('Snakes/snake_poep_groen.png').convert_alpha()
        self.tail_rotation = 0

        self.body_vertical = pygame.image.load('Snakes/snake_lichaam_groen.png').convert_alpha()
        self.body_rotation = 0

        self.body_bl = pygame.image.load('Snakes/snake_boog_bl_groen.png').convert_alpha()
        self.body_br = pygame.image.load('Snakes/snake_boog_br_groen.png').convert_alpha()
        self.body_ol = pygame.image.load('Snakes/snake_boog_ol_groen.png').convert_alpha()
        self.body_or = pygame.image.load('Snakes/snake_boog_or_groen.png').convert_alpha()
...
class SNAKE3:
    def __init__(self, start_pos):
        ...
        self.head = pygame.image.load('Snakes/snake_hooft_oragne.png').convert_alpha()
        self.head_rotation = 0

        self.tail = pygame.image.load('Snakes/snake_poep_oragne.png').convert_alpha()
        self.tail_rotation = 0

        self.body_vertical = pygame.image.load('Snakes/snake_lichaam_oragne.png').convert_alpha()
        self.body_rotation = 0

        self.body_bl = pygame.image.load('Snakes/snake_boog_bl_oragne.png').convert_alpha()
        self.body_br = pygame.image.load('Snakes/snake_boog_br_oragne.png').convert_alpha()
        self.body_ol = pygame.image.load('Snakes/snake_boog_ol_oragne.png').convert_alpha()
        self.body_or = pygame.image.load('Snakes/snake_boog_or_oragne.png').convert_alpha()

    def draw_snake3(self):
        self.update_head_graphics()
        self.update_tail_graphics()
...
class MAIN:
    def __init__(self):
      ...
      self.snake2 = SNAKE2(Vector2(10, 10))
      self.snake3 = SNAKE3(Vector2(15, 10))
      self.dot = DOT()

    def update(self):
       self.snake.move_snake()
       self.snake2.move_snake2()
       self.snake3.move_snake3()
